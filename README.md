...
* `DATABASE_NAME`: Name of the database in [mongoDB](https://github.com/khairulikhwan2344/PROFESSOR-BOT). For more help watch this [video](https://youtu.be/1G1XwEOnxxo)
